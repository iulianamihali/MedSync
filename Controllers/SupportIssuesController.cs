...
namespace MedSync.Controllers
{
    ...
    [AuthorizeUserType(UserType.GlobalAdmin, UserType.LocalAdmin, UserType.Doctor, UserType.Patient)]
    public class SupportIssuesController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddSupportIssue([FromBody] AddSupportIssueRequestDto request)
        {
        ...
        public async Task<IActionResult> UpdateSupportIssueStatus([FromQuery] Guid id, [FromQuery] StatusSupportEnumType status)
        {
