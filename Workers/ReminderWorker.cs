            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                var appointments = await db
                    ...
                    .Select(a => new
                    {
                        ...
                        Email = a.Patient != null
                            ? a.Patient.User.Email
                            : a.UnregisteredPatient.Email,
                        ...
                        InstitutionAddress = a.Institution.Address != null
                            ? $"{a.Institution.Address.City}, {a.Institution.Address.Street}, {a.Institution.Address.Number}, {a.Institution.Address.Country}"
                            : string.Empty,
                    })
