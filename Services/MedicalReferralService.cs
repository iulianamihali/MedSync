...
namespace MedSync.Services
{
    public class MedicalReferralService : IMedicalReferralService
    {
        ...
        public async Task<MedicalReferralPdfDto> GetMedicalReferralPdfDataAsync(
            Guid medicalReferralId
        )
        {
            var medicalReferral = await _context
                .MedicalReferrals.Where(m => m.Id == medicalReferralId)
        ...
        public async Task<List<GetAppointmentReferralsResponseDto>> GetAppointmentReferralsAsync(
            Guid appointmentId
        )
        {
